...
g++ -c -o operator.o OperatorPrecedenceParser.cpp -std=c++17 -g
g++ -c -o lrparser.o LRParser.cpp -std=c++17 -g
g++ -o tokenizer tokenizer.o tester.o tokenizer_checker.o syntaxanalyzer.o lexicalscanner.o topdownsyntaxanalyzer.o symboltable.o tabletopdownsyntaxanalyzer.o lrparser.o operator -std=c++17 -g