...
g++ -o tokenizer tokenizer.o tester.o tokenizer_checker.o syntaxanalyzer.o lexicalscanner.o topdownsyntaxanalyzer.o symboltable.o tabletopdownsyntaxanalyzer.o -std=c++17 -g